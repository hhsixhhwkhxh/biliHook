...
public class ManageHomePagePush extends FunctionsBase {
    ...
    public void run(final XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        ...
        if(descButtonField==null){
            Utils.reportError("ManageHomePagePush 错误 descButtonField未找到");
            return;
        }
        ...
        if(rcmdReasonStyleField==null){
            Utils.reportError("ManageHomePagePush 错误 rcmdReasonStyleField未找到");
            return;
        }
        ...
        if(storyCardIconField==null){
            Utils.reportError("ManageHomePagePush 错误 storyCardIconField未找到");
            return;
        }
        ...
        if(trackIdField==null){
            Utils.reportError("ManageHomePagePush 错误 trackIdField未找到");
            return;
        }
        ...
        if(cardTypeField==null){
            Utils.reportError("ManageHomePagePush 错误 cardTypeField未找到");
            return;
        }
