...
public class RemoveNavigationBarSign extends FunctionsBase {
    ...
    public void run(final XC_LoadPackage.LoadPackageParam lpparam) throws Throwable{
        ...
        Method TabSetMethod = Untils.selectMethod(XposedHelpers.findClass( "com.bilibili.lib.homepage.widget.TabHost",lpparam.classLoader),void.class,int.class,View.class);
        if(TabSetMethod!=null){
            XposedBridge.hookMethod(TabSetMethod,new XC_MethodHook(){
                    ...
                    protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                        ...
                        TextView textview = baseView.findViewById(Untils.getViewID("tab_text"));
